 ...
 */
public class DockerfileCreateCommandImpl extends AbstractProjectCommand implements DockerfileSetupCommand
{
   ...
   {
      return Metadata.forCommand(getClass()).name("Dockerfile: Create")
